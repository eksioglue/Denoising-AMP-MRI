...
The folder contains all the functions and sample data necessary for demonstrating the Denosing-AMP-MRI algorithm for MRI reconstruction as introduced in [1]. 
...
* The folder "Functions" contains the necessary subfunctions:
	...
	- "bm3d_thr_color.mexw64" and "bm3d_thr_color.mexmaci64" realize the BM3D denoising algorithm [3] for 64-bit Windows and Mac platforms, respectively. You should download them from "http://www.cs.tut.fi/~foi/GCF-BM3D/index.html#ref_software" .
